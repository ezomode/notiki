...
class AlertComponent {
    ...
    cssClass(alert) {
        ...
        const alertTypeClass = {
            [_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertType"].Success]: 'alert alert-success',
            [_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertType"].Error]: 'alert alert-danger',
            [_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertType"].Info]: 'alert alert-info',
            [_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertType"].Warning]: 'alert alert-warning'
        };
...
AlertComponent.ɵfac = function AlertComponent_Factory(t) { return new (t || AlertComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AlertComponent, [{
    ...
    }], function () { return [{ type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }, { type: _alert_service__WEBPACK_IMPORTED_MODULE_1__["AlertService"] }]; }, { id: [{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "encryptP", function() { return encryptP; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "decryptP", function() { return decryptP; });
...
function encryptP(pass, payload) {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(encrypt(pass, payload)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(n => n));
}
function decryptP(pass, s) {
    return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(decrypt(pass, s)).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(n => n));
}
...
class ApiService {
    ...
    sendNote(pass, title, text, releaseDate) {
        return encryptP(pass, title)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(titleEnc => Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["from"])(encrypt(pass, text))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(textEnc => this.http.post(this.apiUrl + '/note/' + name, {
            'pass': pass,
            'release': releaseDate,
            'title': titleEnc,
            'text': textEnc
    ...
    getNotes(pass) {
        return this.http
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(value => value))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(n => decryptP(pass, n.title)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(title => {
            n.title = title;
            return n;
        }))))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(n => n))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(n => decryptP(pass, n.text)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(text => {
            n.text = text;
            return n;
        }))))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(n => n));
    }
    saveKeyToGH(pass, token) {
        this.savePass(pass);
        this.saveKey(token);
        const octokit = new _octokit_rest__WEBPACK_IMPORTED_MODULE_5__["Octokit"]({ auth: this.getKey(), log: console });
        this.getGHKey()
            .then(file => {
            console.log(file);
            ...
            .then(_ => {
            encryptP(pass, token)
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["flatMap"])(tokenEnc => octokit.repos.createOrUpdateFile({
                owner: 'ezomode',
                repo: 'notiki',
                path: gh_key_path,
    ...
    getGHKey() {
        return new _octokit_rest__WEBPACK_IMPORTED_MODULE_5__["Octokit"]({ auth: this.getKey(), log: console })
            .repos
...
ApiService.ɵfac = function ApiService_Factory(t) { return new (t || ApiService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_alert_service__WEBPACK_IMPORTED_MODULE_7__["AlertService"])); };
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ApiService, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_6__["HttpClient"] }, { type: _alert_service__WEBPACK_IMPORTED_MODULE_7__["AlertService"] }]; }, null); })();
...
function encrypt(password, plaintext) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
        ...
        const key = yield crypto.subtle.importKey('raw', pwHash, 'AES-GCM', false, ['encrypt']); // generate key from pw
...
function decrypt(password, ciphertext) {
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
        ...
        const key = yield crypto.subtle.importKey('raw', pwHash, 'AES-GCM', false, ['decrypt']); // use pw to generate key
...
/* harmony import */ var _chrono_chrono_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./chrono/chrono.component */ "./src/app/chrono/chrono.component.ts");
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 2, vars: 0, template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_alert_alert_component__WEBPACK_IMPORTED_MODULE_1__["AlertComponent"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterOutlet"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2FwcC5jb21wb25lbnQuY3NzIn0= */"] });
...
/* harmony import */ var _chrono_chrono_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chrono/chrono.component */ "./src/app/chrono/chrono.component.ts");
...
/* harmony import */ var _setup_setup_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./setup/setup.component */ "./src/app/setup/setup.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_3__["AppComponent"],
        _chrono_chrono_component__WEBPACK_IMPORTED_MODULE_5__["ChronoComponent"],
        _alert_alert_component__WEBPACK_IMPORTED_MODULE_8__["AlertComponent"],
        _setup_setup_component__WEBPACK_IMPORTED_MODULE_12__["SetupComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_6__["FormsModule"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbPaginationModule"],
        _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_7__["NgbAlertModule"], _angular_fire__WEBPACK_IMPORTED_MODULE_11__["AngularFireModule"], _angular_fire_analytics__WEBPACK_IMPORTED_MODULE_9__["AngularFireAnalyticsModule"]] }); })();
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _chrono_chrono_component__WEBPACK_IMPORTED_MODULE_5__["ChronoComponent"],
                    _alert_alert_component__WEBPACK_IMPORTED_MODULE_8__["AlertComponent"],
                    _setup_setup_component__WEBPACK_IMPORTED_MODULE_12__["SetupComponent"],
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _app_routing_module__WEBPACK_IMPORTED_MODULE_2__["AppRoutingModule"],
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ChronoComponent", function() { return ChronoComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/__ivy_ngcc__/fesm2015/core.js");
...
const _c0 = ["content"];
function ChronoComponent_app_setup_1_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "app-setup");
} }
function ChronoComponent_div_7_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵelement"](0, "div", 2);
} }
function ChronoComponent_ng_template_8_tr_15_Template(rf, ctx) { if (rf & 1) {
...
function ChronoComponent_ng_template_8_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ChronoComponent_ng_template_8_Template_button_click_3_listener() { const modal_r5 = ctx.$implicit; return modal_r5.dismiss("Cross click"); });
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ChronoComponent_ng_template_8_Template_button_click_17_listener() { const modal_r5 = ctx.$implicit; return modal_r5.close("Close click"); });
...
class ChronoComponent {
    constructor(formBuilder, api, as, modalService, analytics) {
        ...
        this.notes = [];
        this.date = new Date();
        this.releaseDate = { day: this.date.getDate(), month: this.date.getMonth() + 1, year: this.date.getFullYear() };
    }
    ngOnInit() {
...
ChronoComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineComponent"]({ type: ChronoComponent, selectors: [["app-chrono"]], viewQuery: function ChronoComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function ChronoComponent_Template_form_ngSubmit_16_listener() { return ctx.sendNote(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("click", function ChronoComponent_Template_button_click_39_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵrestoreView"](_r11); const _r4 = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵreference"](37); return _r4.toggle(); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵlistener"]("ngSubmit", function ChronoComponent_Template_form_ngSubmit_51_listener() { return ctx.getNotes(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](ChronoComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }, { type: _api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"] }, { type: _alert_service__WEBPACK_IMPORTED_MODULE_4__["AlertService"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_5__["NgbModal"] }, { type: _angular_fire_analytics__WEBPACK_IMPORTED_MODULE_6__["AngularFireAnalytics"] }]; }, { content: [{
...
class SetupComponent {
    constructor(formBuilder, api, as, modalService) {
        this.formBuilder = formBuilder;
        this.api = api;
        this.as = as;
        this.modalService = modalService;
...
SetupComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: SetupComponent, selectors: [["app-setup"]], decls: 17, vars: 1, consts: [[1, "card", "card-default"], [1, "card-header"], [1, "card-body"], [3, "formGroup", "ngSubmit"], [1, "form-group", "row"], [1, "col-sm-3", "col-form-label"], [1, "col-sm-9"], ["type", "text", "formControlName", "api_key", 1, "form-control"], ["type", "password", "formControlName", "pass", 1, "form-control"], [1, "form-group"], ["type", "submit", 1, "btn", "btn-primary", "col-sm-3", "col-form-label", "float-right"]], template: function SetupComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SetupComponent_Template_form_ngSubmit_4_listener() { return ctx.setupGH(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SetupComponent, [{
    ...
    }], function () { return [{ type: _angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"] }, { type: _api_service__WEBPACK_IMPORTED_MODULE_2__["ApiService"] }, { type: _alert_service__WEBPACK_IMPORTED_MODULE_3__["AlertService"] }, { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_4__["NgbModal"] }]; }, null); })();
...
module.exports = __webpack_require__(/*! /Users/akarmeliuk/my/notiki-github/src/main.ts */"./src/main.ts");
